...
class GetColumnType:
    ...
    def _type_from_return_value(self, returning):
        ...
        mapping = {
            ...
            "rct__germdefence__ccg_code": "str",
            "rct__germdefence__listsize_Jan21": "int",
            "rct__germdefence__deprivation_score": "int",
            "rct__germdefence__intervention": "str",
            "rct__germdefence__IntCon": "str",
            "rct__germdefence__List_size": "int",
            "rct__germdefence__IMD_rank": "int",
            "rct__germdefence__IMD_decile": "int",
            "rct__germdefence__MeanAge": "float",
            "rct__germdefence__MedianAge": "float",
            "rct__germdefence__Av_rooms_per_house": "float",
            "rct__germdefence__Minority_ethnic_total": "str",
            "rct__germdefence__n_times_visited_mean": "float",
            "rct__germdefence__n_pages_viewed_mean": "float",
            "rct__germdefence__total_visit_time_mean": "float",
            "rct__germdefence__prop_engaged_visits": "int",
            "rct__germdefence__n_engaged_visits_mean": "float",
            "rct__germdefence__n_engaged_pages_viewed_mean_mean": "float",
            "rct__germdefence__N_visits_practice": "int",
            "rct__germdefence__group_mean_behaviour_mean": "float",
            "rct__germdefence__group_mean_intention_mean": "float",
            "rct__germdefence__N_completers_RI_behav": "float",
            "rct__germdefence__N_completers_RI_intent": "float",
            "rct__germdefence__hand_behav_practice_mean": "float",
            "rct__germdefence__hand_intent_practice_mean": "float",
            "rct__germdefence__N_completers_HW_behav": "float",
            "rct__germdefence__N_goalsetting_completers_per_practice": "float",
        }
        try:
