...
ISARIC_COLUMN_MAPPINGS = {
    ...
    "cxr_count": "int",
    "cxr_done": "str",
    "daily_alt_lborres": "int",
    "daily_alt_lbyn": "str",
    "daily_altop_lbyn": "str",
    "daily_aptt_lborres": "str",
    "daily_aptt_lbyn": "str",
    "daily_apttop_lborres": "str",
    "daily_ast_lborres": "int",
    "daily_ast_lbyn": "str",
    "daily_bil_lborres": "int",
    "daily_bil_lborresu": "str",
    "daily_bil_lbyn": "str",
    "daily_bilop_lborres": "str",
    "daily_bun_lborres": "str",
