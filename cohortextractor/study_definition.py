    ...
    def to_file(
        ...
        if expectations_population:
            ...
            if not is_csv_filename(filename):
                # Convert the data generated by make_df_from_expectations to the correct
                # format for binary outputs.  This matches the approach taken in the
                # backend .to_file methods.
                buffer = StringIO()
