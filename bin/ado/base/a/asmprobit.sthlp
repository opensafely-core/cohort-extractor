...
{p2colset 1 18 20 2}{...}
{p2col:{bf:[R] asmprobit} {hline 2}}Alternative-specific multinomial probit
	regression{p_end}
{p2col:}({browse "http://www.stata.com/manuals15/rasmprobit.pdf":View complete PDF manual entry}){p_end}
{p2colreset}{...}
