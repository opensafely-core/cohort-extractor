...
{viewerjumpto "Syntax" "bayes_mepoisson##syntax"}{...}
{viewerjumpto "Menu" "bayes_mepoisson##menu"}{...}
{viewerjumpto "Description" "bayes_mepoisson##description"}{...}
{viewerjumpto "Links to PDF documentation" "bayes_mepoisson##linkspdf"}{...}
{viewerjumpto "Examples" "bayes_mepoisson##examples"}{...}
{viewerjumpto "Stored results" "bayes_mepoisson##results"}{...}
{p2colset 1 29 31 2}{...}
{p2col:{bf:[BAYES] bayes: mepoisson} {hline 2}}Bayesian multilevel Poisson 
regression{p_end}
{p2col:}({mansection BAYES bayesmepoisson:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{depvar} {it:fe_equation} [{cmd:||} {it:re_equation}] 
	[{cmd:||} {it:re_equation} ...] 
	[{cmd:,} {it:{help bayes_mepoisson##options_table:options}}]
...
{p 12 24 2}
	[{indepvars}] {ifin}
        [{it:{help bayes_mepoisson##weight:weight}}]
	[{cmd:,} {it:{help bayes_mepoisson##fe_options:fe_options}}]
...
{p 12 24 2}
	{it:levelvar}{cmd::} [{varlist}]
		[{cmd:,} {it:{help bayes_mepoisson##re_options:re_options}}]
...
{synoptline}
{syntab:Model}
{synopt :{opth cov:ariance(mepoisson##vartype:vartype)}}variance-covariance 
...
{p 4 6 2}
{cmd:bayes:} {cmd:mepoisson,} {cmd:level()} is equivalent to 
{cmd:bayes,} {cmd:clevel():} {cmd:mepoisson}.{p_end}
{p 4 6 2}For a detailed description of {it:options}, see
{help mepoisson##options:{it:Options}} in {manhelp mepoisson ME}.{p_end}
...
{phang}
{bf:Statistics > Multilevel mixed-effects models > Bayesian regression > Poisson regression}
...
{pstd}
{cmd:bayes: mepoisson} fits a Bayesian multilevel Poisson regression to a
nonnegative count outcome;
see {manhelp bayes BAYES} and {manhelp mepoisson ME} for details.


{marker linkspdf}{...}
{title:Links to PDF documentation}

        {mansection BAYES bayesmepoissonQuickstart:Quick start}

        {mansection BAYES bayesmepoissonRemarksandexamples:Remarks and examples}

        {mansection BAYES bayesmepoissonMethodsandformulas:Methods and formulas}
...
{pstd}Fit Bayesian two-level Poisson regression with random intercepts 
by {cmd:region} using default priors{p_end}
{phang2}{cmd:. bayes: mepoisson deaths uv, exposure(expected) || region:}{p_end}

{pstd}Increase the burn-in period to 5,000 from the default of 2,500; use 
...
{pstd}
In addition to the main model parameters, display results for regions 
1 through 5{p_end}
{phang2}{cmd:. bayes, showreffects({U0[(1/5).region]})}

{pstd}
Check MCMC convergence for the main model parameters and 
the 1st, 10th, and 15th random effects{p_end}
...
{pstd}
Display estimation results using {cmd:mepoisson}'s parameter labels and 
compute log marginal-likelihood on replay{p_end}
{phang2}{cmd:. bayes, melabel remargl}

{pstd}Fit Bayesian three-level Poisson regression with random intercepts by
{cmd:nation} and by {cmd:region} nested within {cmd:nation}{p_end}
