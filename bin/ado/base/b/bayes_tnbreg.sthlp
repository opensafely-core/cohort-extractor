...
{viewerjumpto "Syntax" "bayes_tnbreg##syntax"}{...}
{viewerjumpto "Menu" "bayes_tnbreg##menu"}{...}
{viewerjumpto "Description" "bayes_tnbreg##description"}{...}
{viewerjumpto "Links to PDF documentation" "bayes_tnbreg##linkspdf"}{...}
{viewerjumpto "Examples" "bayes_tnbreg##examples"}{...}
{viewerjumpto "Stored results" "bayes_tnbreg##results"}{...}
{p2colset 1 26 28 2}{...}
{p2col:{bf:[BAYES] bayes: tnbreg} {hline 2}}Bayesian truncated negative
binomial regression{p_end}
{p2col:}({mansection BAYES bayestnbreg:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{depvar} [{indepvars}]
{ifin}
[{it:{help bayes_tnbreg##weight:weight}}]
[{cmd:,} {it:options}]
...
{p 4 6 2}
{cmd:bayes:} {cmd:tnbreg,} {cmd:level()} is equivalent to 
{cmd:bayes,} {cmd:clevel():} {cmd:tnbreg}.{p_end}
{p 4 6 2}For a detailed description of {it:options}, see
{help tnbreg##options:{it:Options}} in {manhelp tnbreg R}.{p_end}
...
{phang}
{bf:Statistics > Count outcomes > Bayesian regression > Truncated negative binomial regression}
...
{pstd}
{cmd:bayes: tnbreg} fits a Bayesian truncated negative binomial regression
to a positive count outcome whose values are all above the truncation point;
see {manhelp bayes BAYES} and {manhelp tnbreg R:tnbreg} for details.


{marker linkspdf}{...}
{title:Links to PDF documentation}

        {mansection BAYES bayestnbregQuickstart:Quick start}

        {mansection BAYES bayestnbregRemarksandexamples:Remarks and examples}

        {mansection BAYES bayestnbregMethodsandformulas:Methods and formulas}
...
{pstd}
Fit Bayesian truncated negative binomial regression model with the default 
lower truncation point of 0; display dots during simulation{p_end}
...
coefficients and log-overdispersion parameter, specifying random-number 
seed for reproducibility{p_end}
{phang2}{cmd:. bayes, normalprior(10) rseed(12345) dots:}
          {cmd:tnbreg los died hmo type2-type3}

{pstd}
Display a 95% highest posterior density (HPD) credible interval instead of 
the default equal-tailed{p_end}
