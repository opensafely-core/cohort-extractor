...
{viewerjumpto "Syntax" "bayes_meprobit##syntax"}{...}
{viewerjumpto "Menu" "bayes_meprobit##menu"}{...}
{viewerjumpto "Description" "bayes_meprobit##description"}{...}
{viewerjumpto "Links to PDF documentation" "bayes_meprobit##linkspdf"}{...}
{viewerjumpto "Examples" "bayes_meprobit##examples"}{...}
{viewerjumpto "Stored results" "bayes_meprobit##results"}{...}
{p2colset 1 28 30 2}{...}
{p2col:{bf:[BAYES] bayes: meprobit} {hline 2}}Bayesian multilevel probit 
regression{p_end}
{p2col:}({mansection BAYES bayesmeprobit:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{depvar} {it:fe_equation} [{cmd:||} {it:re_equation}] 
	[{cmd:||} {it:re_equation} ...] 
	[{cmd:,} {it:{help bayes_meprobit##options_table:options}}]
...
{p 12 24 2}
	[{indepvars}] {ifin}
        [{it:{help bayes_meprobit##weight:weight}}]
	[{cmd:,} {it:{help bayes_meprobit##fe_options:fe_options}}]
...
{p 12 24 2}
	{it:levelvar}{cmd::} [{varlist}]
		[{cmd:,} {it:{help bayes_meprobit##re_options:re_options}}]
...
{synoptline}
{syntab:Model}
{synopt :{opth cov:ariance(meprobit##vartype:vartype)}}variance-covariance 
...
{p 4 6 2}
{cmd:bayes:} {cmd:meprobit,} {cmd:level()} is equivalent to 
{cmd:bayes,} {cmd:clevel():} {cmd:meprobit}.{p_end}
{p 4 6 2}For a detailed description of {it:options}, see
{help meprobit##options:{it:Options}} in {manhelp meprobit ME}.{p_end}
...
{phang}
{bf:Statistics > Multilevel mixed-effects models > Bayesian regression > Probit regression}
...
{pstd}
{cmd:bayes: meprobit} fits a Bayesian multilevel probit regression to a
binary outcome;
see {manhelp bayes BAYES} and {manhelp meprobit ME} for details.


{marker linkspdf}{...}
{title:Links to PDF documentation}

        {mansection BAYES bayesmeprobitQuickstart:Quick start}

        {mansection BAYES bayesmeprobitRemarksandexamples:Remarks and examples}

        {mansection BAYES bayesmeprobitMethodsandformulas:Methods and formulas}
...
{pstd}
Fit Bayesian two-level probit regression with random intercepts by 
...
{pstd}
Display estimation results using {cmd:meprobit}'s parameter labels and 
