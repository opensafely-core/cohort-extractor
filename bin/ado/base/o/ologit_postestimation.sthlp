...
{viewerjumpto "Links to PDF documentation" "ologit_postestimation##linkspdf"}{...}
...
{p2colset 1 30 32 2}{...}
{p2col:{bf:[R] ologit postestimation} {hline 2}}Postestimation tools for
ologit{p_end}
{p2col:}({mansection R ologitpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection R ologitpostestimationRemarksandexamples:Remarks and examples}
