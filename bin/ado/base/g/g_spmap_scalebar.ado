...
*! -g_spmap_scalebar-: Auxiliary program for -g_spmap-                             
...
program g_spmap_scalebar, rclass
version 9.2
...
local GRAPH `"`GRAPH' fi(100) lc(`ocolor') lw(`osize') la(`oalign')) "'
...
local GRAPH `"`GRAPH' cmissing(n) fc(white) lc(`ocolor') lw(`osize') la(`oalign')) "'
...
local GRAPH `"`GRAPH' mlabgap(*0.1) la(`talign')) "'
