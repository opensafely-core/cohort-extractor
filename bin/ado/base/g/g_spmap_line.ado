...
*! -g_spmap_line-: Auxiliary program for -g_spmap-                                 
...
if _rc {
   di as err "{p}Problem with option {bf:{ul:lin}e()}: file "         ///
             "{bf:`data'} specified in suboption {bf:{ul:d}ata()} "   ///
             "is not a valid {help grmap##sd_line:{it:line}} "        ///
             "dataset {p_end}"
   exit 198
}
...
g_spmap_psl, l(`pattern') m(`NG') o({bf:{ul:pa}ttern()}) d(`pattern_d')
local pattern `"`s(pl)'"'
