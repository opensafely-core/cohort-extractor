...
*! -g_spmap_label-: Auxiliary program for -g_spmap-                                
...
/* Parse option length() */
g_spmap_psl, l(`length') m(`NG') o({bf:{ul:le}ngth()}) d(`length_d')
local length `"`s(pl)'"'
...
/* Parse option size() */
g_spmap_psl, l(`size') m(`NG') o({bf:{ul:si}ze()}) d(`size_d')
local size `"`s(pl)'"'
...
if `EXIST' {
   ...
   g_spmap_psl, l(`color') m(`NG') o({bf:{ul:co}lor()}) d(`color_d')
   local color `"`s(pl)'"'
}

/* Parse option position() */
g_spmap_psl, l(`position') m(`NG') o({bf:{ul:po}sition()}) d(`position_d')
local position `"`s(pl)'"'

/* Parse option gap() */
g_spmap_psl, l(`gap') m(`NG') o({bf:{ul:ga}p()}) d(`gap_d')
local gap `"`s(pl)'"'

/* Parse option angle() */
g_spmap_psl, l(`angle') m(`NG') o({bf:{ul:an}gle()}) d(`angle_d')
local angle `"`s(pl)'"'
