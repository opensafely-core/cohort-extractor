{* *! version 1.0.0  16may2016}{...}
    {cmd:igaussian(}{it:m}{cmd:,}{it:a}{cmd:,}{it:x}{cmd:)}
{p2colset 8 22 22 2}{...}
{p2col: Description:}the cumulative inverse Gaussian distribution with mean
{it:m} and shape parameter {it:a}; {cmd:0} if x {ul:<} 0{p_end}
