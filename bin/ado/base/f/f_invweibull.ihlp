...
{p2colset 8 22 22 2}{...}
{p2col: Description:}the inverse cumulative Weibull distribution with shape
{it:a} and scale {it:b}: if {cmd:weibull(}{it:a}{cmd:,}{it:b}{cmd:,}{it:x}{cmd:)} = {it:p}, then
...
{p2colset 8 22 22 2}{...}
{p2col: Description:}the inverse cumulative Weibull distribution with
shape {it:a}, scale {it:b}, and location {it:g}: if
{cmd:weibull(}{it:a}{cmd:,}{it:b}{cmd:,}{it:g}{cmd:,}{it:x}{cmd:)} = {it:p}, then
