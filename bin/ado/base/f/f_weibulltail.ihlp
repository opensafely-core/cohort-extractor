...
{p2colset 8 22 22 2}{...}
{p2col: Description:}the reverse cumulative Weibull distribution with shape {it:a} and
scale {it:b}{p_end}

{p2col:}{cmd:weibulltail(}{it:a}{cmd:,}{it:b}{cmd:,}{it:x}{cmd:)} =
{cmd:weibulltail(}{it:a}{cmd:,}{it:b}{cmd:,0,}{it:x}{cmd:)},
where {it:a} is the shape, {it:b} is the scale, and {it:x} is the value of a
...
{p2colset 8 22 22 2}{...}
{p2col: Description:}the reverse cumulative Weibull distribution with shape {it:a},
