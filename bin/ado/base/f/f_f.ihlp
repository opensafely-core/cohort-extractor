{* *! version 1.1.1  02mar2015}{...}
    {cmd:F(}{it:df1}{cmd:,}{it:df2}{cmd:,}{it:f}{cmd:)}
{p2colset 8 22 22 2}{...}
{p2col: Description:}the cumulative F distribution with {it:df1} numerator and
	{it:df2} denominator degrees of freedom; {cmd:0} if {it:f} < 0{p_end}
