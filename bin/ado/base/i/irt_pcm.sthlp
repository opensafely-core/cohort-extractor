...
{viewerjumpto "Links to PDF documentation" "irt_pcm##linkspdf"}{...}
{viewerjumpto "Options" "irt pcm##options"}{...}
{viewerjumpto "Examples" "irt pcm##examples"}{...}
{viewerjumpto "Stored results" "irt pcm##results"}{...}
{p2colset 1 18 20 2}{...}
{p2col:{bf:[IRT] irt pcm} {hline 2}}Partial credit model{p_end}
{p2col:}({mansection IRT irtpcm:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection IRT irtpcmQuickstart:Quick start}

        {mansection IRT irtpcmRemarksandexamples:Remarks and examples}

        {mansection IRT irtpcmMethodsandformulas:Methods and formulas}
...
{pstd}
{cmd:irt pcm} and {cmd:irt gpcm} store the following in {cmd:e()}:
...
{synopt:{cmd:e(model1)}}{cmd:pcm} or {cmd:gpcm}{p_end}
