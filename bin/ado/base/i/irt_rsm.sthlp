...
{viewerjumpto "Links to PDF documentation" "irt_rsm##linkspdf"}{...}
...
{p2colset 1 18 20 2}{...}
{p2col:{bf:[IRT] irt rsm} {hline 2}}Rating scale model{p_end}
{p2col:}({mansection IRT irtrsm:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
parameter.  The distances between the difficulties of adjacent outcomes are
equal across the items.


{marker linkspdf}{...}
{title:Links to PDF documentation}

        {mansection IRT irtrsmQuickstart:Quick start}

        {mansection IRT irtrsmRemarksandexamples:Remarks and examples}

        {mansection IRT irtrsmMethodsandformulas:Methods and formulas}
...
{phang2}{browse "https://www.youtube.com/watch?v=q5trE0r2sv4":Item response theory using Stata: Rating scale models (RSMs)}
