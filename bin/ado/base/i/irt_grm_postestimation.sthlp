...
{viewerjumpto "Links to PDF documentation" "irt_grm_postestimation##linkspdf"}{...}
{viewerjumpto "predict" "irt grm postestimation##syntax_predict"}{...}
{viewerjumpto "Examples" "irt grm postestimation##examples"}{...}
{p2colset 1 33 35 2}{...}
{p2col:{bf:[IRT] irt grm postestimation} {hline 2}}Postestimation tools for 
irt grm {p_end}
{p2col:}({mansection IRT irtgrmpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection IRT irtgrmpostestimationMethodsandformulas:Methods and formulas}
