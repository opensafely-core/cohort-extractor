...
{viewerjumpto "Links to PDF documentation" "irt_3pl##linkspdf"}{...}
...
{p2colset 1 18 20 2}{...}
{p2col:{bf:[IRT] irt 3pl} {hline 2}}Three-parameter logistic model{p_end}
{p2col:}({mansection IRT irt3pl:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{synopt :{opt gsepg:uessing}}estimate separate pseudoguessing parameters for each group{p_end}
...
{title:Links to PDF documentation}
        ...
        {mansection IRT irt3plQuickstart:Quick start}

        {mansection IRT irt3plRemarksandexamples:Remarks and examples}

        {mansection IRT irt3plMethodsandformulas:Methods and formulas}
...
estimated for each group.  This option is allowed only when
fitting a group model.
...
{phang2}{browse "https://www.youtube.com/watch?v=wOsgxpE_pEA":Item response theory using Stata: Three-parameter logistic (3PL) models}
...
{synopt:{cmd:e(sepguess1)}}{cmd:1} if model contains a separate pseudoguessing
parameter{p_end}
