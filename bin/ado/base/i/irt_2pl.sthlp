...
{viewerjumpto "Links to PDF documentation" "irt_2pl##linkspdf"}{...}
...
{p2colset 1 18 20 2}{...}
{p2col:{bf:[IRT] irt 2pl} {hline 2}}Two-parameter logistic model{p_end}
{p2col:}({mansection IRT irt2pl:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection IRT irt2plQuickstart:Quick start}

        {mansection IRT irt2plRemarksandexamples:Remarks and examples}

        {mansection IRT irt2plMethodsandformulas:Methods and formulas}
...
{phang2}{browse "https://www.youtube.com/watch?v=0S94pvirTLE":Item response theory using Stata: Two-parameter logistic (2PL) models}
