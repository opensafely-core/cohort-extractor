...
{viewerjumpto "Links to PDF documentation" "irt_3pl_postestimation##linkspdf"}{...}
{viewerjumpto "predict" "irt 3pl postestimation##syntax_predict"}{...}
{viewerjumpto "Examples" "irt 3pl postestimation##examples"}{...}
{p2colset 1 33 35 2}{...}
{p2col:{bf:[IRT] irt 3pl postestimation} {hline 2}}Postestimation tools for 
irt 3pl {p_end}
{p2col:}({mansection IRT irt3plpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection IRT irt3plpostestimationMethodsandformulas:Methods and formulas}
