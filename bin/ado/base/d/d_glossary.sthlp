...
{* Apply text changes to u_glossary and p_glossary, too.}{...}
{vieweralsosee "[D] Glossary" "mansection D Glossary"}{...}
{viewerjumpto "Description" "d_glossary##description"}{...}
{viewerjumpto "Glossary" "d_glossary##glossary"}{...}
{p2colset 1 17 19 2}{...}
{p2col:{bf:[D] Glossary} {hline 2}}Glossary of terms{p_end}
{p2col:}({mansection D Glossary:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{help d_glossary##plainascii:lower, ASCII},
...
{help d_glossary##extascii:extended ASCII},
...
{help d_glossary##encode:encoded} using ASCII.
...
{help d_glossary##bin0:binary 0}, or if it contains the contents of a
...
{help d_glossary##encode:encoded} using either one byte or
several bytes to represent each character.

{pmore}
For example, in {help d_glossary##utf:UTF-8}, the
...
Stata uses {help d_glossary##utf:UTF-8} encoding for
...
{pmore}
All {help d_glossary##plainascii:plain ASCII}
characters (for example, "M" and "9") and many
{help d_glossary##utf:UTF-8} characters that are not
...
{help d_glossary##storagetypes:storage types}.
...
{help d_glossary##ascii:ASCII} and
{help d_glossary##utf:UTF-8}.  Stata uses UTF-8
encoding.
...
{help d_glossary##ascii:ASCII} specification.  Various
{help d_glossary##code_pages:code pages} have been defined over
...
ASCII {help d_glossary##encode:encoding},
...
{marker hexadecimal}{...}
{phang}
{bf:hexadecimal}.  The hexadecimal number system, or simply hex, is a base-16
number system represented by digits 0 through 9 and letters A through F.

{phang}
{bf:higher ASCII}.
See {help d_glossary##extascii:{it:extended ASCII}}.
...
{phang}
{bf:long format and wide format}.  Think of a dataset as having an ID
variable, i, and a variable, j, whose values denote a subobservation.  For
instance, a person might be the i variable, and a year might be the j
variable, so you have information about a set of people across several years.
If this information is organized such that the j variable is explicitly
specified, then the data are in long format; otherwise, they are in wide
format.  For instance,
...
{pmore}
are in long format because the j variable, {cmd:year}, is explicitly
specified.  In the following, the data are in wide format:
...
{pmore}
See {manhelp reshape D} for how to go between long and wide format.

{phang}
{bf:lower ASCII}.
See {help d_glossary##plainascii:{it:plain ASCII}}.

{phang}
{bf:null-terminator}.
See {help d_glossary##bin0:{it:binary 0}}.
...
to {help d_glossary##encode:encode} plain ASCII characters are the same across
different operating systems and are common between ASCII and
{help d_glossary##utf:UTF-8}.

{pmore}
Also see {help d_glossary##ascii:{it:ASCII}} and
{help d_glossary##encode:{it:encodings}}.
...
{help d_glossary##displayfmt:display formats}.

{phang}
{bf:str1}, {bf:str2}, ..., {bf:str2045}.
     See {help d_glossary##strL:{it:strL}}.
...
English {help d_glossary##locale:locale} locale also would return the
title-cased string {cmd:Zen And The Art Of Motorcycle Maintenance}.
...
{phang}
{bf:Unicode}.
Unicode is a standard for {help d_glossary##encode:encoding}
...
{help d_glossary##encode:encoded} with the single
{help d_glossary##codep:code point} U+00F1.  However, the
...
{help d_glossary##codep:code point} U+FB00 (the typographic
ligature "f") to match the sequence of two Latin "f" letters
{help d_glossary##encode:encoded} as U+0066 U+0066.  This is
called compatible equivalence.

{phang}
{bf:Unicode title-cased string}.  See
{help d_glossary##titlecase:{it:titlecase, title-cased string, and Unicode title-cased string}}.

{marker utf}{...}
{phang}
{bf:UTF-8}.  UTF-8 stands for Universal character set + Transformation
Format -- 8-bit.  It is a type of
{help d_glossary##unicode:Unicode}
{help d_glossary##encode:encoding}
...
{phang}
{bf:wide format}. See
{help d_glossary##longwideformat:{it:long and wide format}}.
{p_end}
