...
{viewerjumpto "Links to PDF documentation" "logistic_postestimation##linkspdf"}{...}
...
{p2colset 1 32 34 2}{...}
{p2col:{bf:[R] logistic postestimation} {hline 2}}Postestimation tools for
logistic{p_end}
{p2col:}({mansection R logisticpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection R logisticpostestimationRemarksandexamples:Remarks and examples}

        {mansection R logisticpostestimationMethodsandformulas:Methods and formulas}
