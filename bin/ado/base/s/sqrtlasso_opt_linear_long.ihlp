...
one or more variables from {it:depvar} or {it:varsofinterest}.  This option is
repeatable as long as different variables are given in each specification.
{it:lasso_options} are {cmd:selection(}...{cmd:)}, {cmd:grid(}...{cmd:)}, 
{opt stop(#)}, {opt tolerance(#)}, {opt dtolerance(#)}, and 
{opt cvtolerance(#)}.  When {cmd:sqrtlasso(}{it:varlist}{cmd:,}
