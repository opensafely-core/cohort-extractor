...
{viewerjumpto "Links to PDF documentation" "xtoprobit##linkspdf"}{...}
...
{viewerjumpto "Video example" "xtoprobit##video"}{...}
{viewerjumpto "Stored results" "xtoprobit##results"}{...}
{p2colset 1 19 21 2}{...}
{p2col:{bf:[XT] xtoprobit} {hline 2}}Random-effects ordered probit models{p_end}
{p2col:}({mansection XT xtoprobit:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection XT xtoprobitQuickstart:Quick start}

        {mansection XT xtoprobitRemarksandexamples:Remarks and examples}

        {mansection XT xtoprobitMethodsandformulas:Methods and formulas}
