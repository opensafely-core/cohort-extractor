...
{viewerjumpto "Links to PDF documentation" "xtcloglog##linkspdf"}{...}
...
{p2colset 1 19 21 2}{...}
{p2col:{bf:[XT] xtcloglog} {hline 2}}Random-effects and population-averaged cloglog models{p_end}
{p2col:}({mansection XT xtcloglog:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection XT xtcloglogQuickstart:Quick start}

        {mansection XT xtcloglogRemarksandexamples:Remarks and examples}

        {mansection XT xtcloglogMethodsandformulas:Methods and formulas}
...
{pstd}
The following options are available with {opt xtcloglog} but are not shown in
the dialog box:
