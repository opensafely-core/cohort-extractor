...
{viewerjumpto "Links to PDF documentation" "xtoprobit_postestimation##linkspdf"}{...}
...
{p2colset 1 34 36 2}{...}
{p2col:{bf:[XT] xtoprobit postestimation} {hline 2}}Postestimation tools for xtoprobit{p_end}
{p2col:}({mansection XT xtoprobitpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection XT xtoprobitpostestimationRemarksandexamples:Remarks and examples}
