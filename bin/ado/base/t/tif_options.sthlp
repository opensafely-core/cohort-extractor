...
{viewerjumpto "Links to PDF documentation" "tif_options##linkspdf"}{...}
{viewerjumpto "Options" "tif_options##options"}{...}
{viewerjumpto "Remarks" "tif_options##remarks"}{...}
{p2colset 1 22 24 2}{...}
{p2col:{bf:[G-3]} {it:tif_options} {hline 2}}Options for exporting to tagged
image file format (TIFF){p_end}
{p2col:}({mansection G-3 tif_options:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection G-3 tif_optionsRemarksandexamples:Remarks and examples}
