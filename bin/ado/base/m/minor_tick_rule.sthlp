...
{viewerjumpto "Axis rules for minor ticks" "minor_tick_rule##axis_rules"}{...}
{viewerjumpto "Custom axis labels" "minor_tick_rule##custom"}{...}
{marker axis_rules}{...}
{title:Axis rules for minor ticks}

{pstd}
An axis rule specifies where to place minor ticks and labels on an axis.
...
{pstd}
A {it:numlist} can also be used to specify an axis rule, see {help numlist}.
