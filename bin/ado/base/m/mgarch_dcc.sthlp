...
{viewerjumpto "Links to PDF documentation" "mgarch_dcc##linkspdf"}{...}
...
{p2colset 1 20 22 2}{...}
{p2col:{bf:[TS] mgarch dcc} {hline 2}}Dynamic conditional correlation
multivariate GARCH models{p_end}
{p2col:}({mansection TS mgarchdcc:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection TS mgarchdccQuickstart:Quick start}

        {mansection TS mgarchdccRemarksandexamples:Remarks and examples}

        {mansection TS mgarchdccMethodsandformulas:Methods and formulas}
