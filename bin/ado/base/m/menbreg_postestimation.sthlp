...
{viewerjumpto "Links to PDF documentation" "menbreg_postestimation##linkspdf"}{...}
...
{p2colset 1 32 34 2}{...}
{p2col:{bf:[ME] menbreg postestimation} {hline 2}}Postestimation tools for
menbreg{p_end}
{p2col:}({mansection ME menbregpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection ME menbregpostestimationRemarksandexamples:Remarks and examples}

        {mansection ME menbregpostestimationMethodsandformulas:Methods and formulas}
