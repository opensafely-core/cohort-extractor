...
{viewerjumpto "Links to PDF documentation" "mgarch_ccc##linkspdf"}{...}
...
{p2colset 1 20 22 2}{...}
{p2col:{bf:[TS] mgarch ccc} {hline 2}}Constant conditional correlation
multivariate GARCH models{p_end}
{p2col:}({mansection TS mgarchccc:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection TS mgarchcccQuickstart:Quick start}

        {mansection TS mgarchcccRemarksandexamples:Remarks and examples}

        {mansection TS mgarchcccMethodsandformulas:Methods and formulas}
