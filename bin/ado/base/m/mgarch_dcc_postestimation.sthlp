...
{viewerjumpto "Links to PDF documentation" "mgarch_dcc_postestimation##linkspdf"}{...}
...
{p2colset 1 35 39 2}{...}
{p2col:{bf:[TS] mgarch dcc postestimation} {hline 2}}Postestimation tools
for mgarch dcc{p_end}
{p2col:}({mansection TS mgarchdccpostestimation:View complete PDF manual entry}){p_end}
...
{title:Links to PDF documentation}
        ...
        {mansection TS mgarchdccpostestimationRemarksandexamples:Remarks and examples}

        {mansection TS mgarchdccpostestimationMethodsandformulas:Methods and formulas}
