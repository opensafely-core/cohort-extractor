...
{viewerjumpto "Links to PDF documentation" "mgarch_vcc_postestimation##linkspdf"}{...}
...
{p2colset 1 35 39 2}{...}
{p2col:{bf:[TS] mgarch vcc postestimation} {hline 2}}Postestimation tools
for mgarch vcc{p_end}
{p2col:}({mansection TS mgarchvccpostestimation:View complete PDF manual entry}){p_end}
...
{title:Links to PDF documentation}
        ...
        {mansection TS mgarchvccpostestimationRemarksandexamples:Remarks and examples}

        {mansection TS mgarchvccpostestimationMethodsandformulas:Methods and formulas}
