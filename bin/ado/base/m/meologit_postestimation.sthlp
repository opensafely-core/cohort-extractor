...
{viewerjumpto "Links to PDF documentation" "meologit_postestimation##linkspdf"}{...}
...
{p2colset 1 33 35 2}{...}
{p2col:{bf:[ME] meologit postestimation} {hline 2}}Postestimation tools for meologit{p_end}
{p2col:}({mansection ME meologitpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection ME meologitpostestimationRemarksandexamples:Remarks and examples}

        {mansection ME meologitpostestimationMethodsandformulas:Methods and formulas}
