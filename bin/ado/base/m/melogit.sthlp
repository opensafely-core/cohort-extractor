...
{viewerjumpto "Links to PDF documentation" "melogit##linkspdf"}{...}
...
{p2colset 1 17 19 2}{...}
{p2col:{bf:[ME] melogit} {hline 2}}Multilevel mixed-effects logistic regression
{p_end}
{p2col:}({mansection ME melogit:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
For more details, see {manhelp bayes_melogit BAYES:bayes: melogit}.{p_end}
{p 4 6 2}
...
{title:Links to PDF documentation}
        ...
        {mansection ME melogitQuickstart:Quick start}

        {mansection ME melogitRemarksandexamples:Remarks and examples}

        {mansection ME melogitMethodsandformulas:Methods and formulas}
...
{phang2}{cmd:. melogit c_use i.urban age child* || district:}{p_end}

{pstd}Two-level random-intercept and random-coefficient model{p_end}
{phang2}{cmd:. melogit c_use i.urban age child* || district: i.urban}{p_end}

{pstd}Two-level random-intercept and random-coefficient model, correlated random
effects{p_end}
{phang2}{cmd:. melogit c_use i.urban age child* || district: i.urban,}
