...
{viewerjumpto "Links to PDF documentation" "meprobit##linkspdf"}{...}
...
{p2colset 1 18 20 2}{...}
{p2col:{bf:[ME] meprobit} {hline 2}}Multilevel mixed-effects probit regression
{p_end}
{p2col:}({mansection ME meprobit:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
For more details, see {manhelp bayes_meprobit BAYES:bayes: meprobit}.{p_end}
{p 4 6 2}
...
{title:Links to PDF documentation}
        ...
        {mansection ME meprobitQuickstart:Quick start}

        {mansection ME meprobitRemarksandexamples:Remarks and examples}

        {mansection ME meprobitMethodsandformulas:Methods and formulas}
...
{phang2}{cmd:. meprobit c_use i.urban age child* || district:}{p_end}

{pstd}Two-level random-intercept and random-coefficient model{p_end}
{phang2}{cmd:. meprobit c_use i.urban age child* || district: i.urban}{p_end}

{pstd}Two-level random-intercept and random-coefficient model, correlated random
effects{p_end}
{phang2}{cmd:. meprobit c_use i.urban age child* || district: i.urban,}
