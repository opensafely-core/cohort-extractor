...
{viewerjumpto "Links to PDF documentation" "meoprobit##linkspdf"}{...}
...
{p2colset 1 19 21 2}{...}
{p2col:{bf:[ME] meoprobit} {hline 2}}Multilevel mixed-effects ordered probit
regression{p_end}
{p2col:}({mansection ME meoprobit:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
For more details, see {manhelp bayes_meoprobit BAYES:bayes: meoprobit}.{p_end}
{p 4 6 2}
...
{title:Links to PDF documentation}
        ...
        {mansection ME meoprobitQuickstart:Quick start}

        {mansection ME meoprobitRemarksandexamples:Remarks and examples}

        {mansection ME meoprobitMethodsandformulas:Methods and formulas}
