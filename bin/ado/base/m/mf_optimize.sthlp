...
{viewerjumpto "Links to PDF documentation" "mf_optimize##linkspdf"}{...}
...
{p2colset 1 21 23 2}{...}
{p2col:{bf:[M-5] optimize()} {hline 2}}Function optimization
{p_end}
{p2col:}({mansection M-5 optimize():View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection M-5 optimize()Remarksandexamples:Remarks and examples}
...
{cmd:optimize_result_converged()} is set to 0.  The default {it:maxiter} is
Stata's {bf:{help creturn:c(maxiter)}}, which is
