...
{viewerjumpto "Links to PDF documentation" "mecloglog_postestimation##linkspdf"}{...}
...
{p2colset 1 34 36 2}{...}
{p2col:{bf:[ME] mecloglog postestimation} {hline 2}}Postestimation tools for
mecloglog{p_end}
{p2col:}({mansection ME mecloglogpostestimation:View complete PDF manual entry}){p_end}
{p2colreset}{...}
...
{title:Links to PDF documentation}
        ...
        {mansection ME mecloglogpostestimationRemarksandexamples:Remarks and examples}

        {mansection ME mecloglogpostestimationMethodsandformulas:Methods and formulas}
